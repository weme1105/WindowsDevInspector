...
public static class BuiltInCheckCatalog
{
    ...
    private static IReadOnlyList<TechnologyDefinition> CreateTechnologies()
    {
        return [
            ...
            Technology("flask", "Flask", ["backend"], ["backend.python-cli"]),
            Technology("pytest", "pytest", ["qa"], ["backend.python-cli"]),
            Technology("php", "PHP", ["backend"], ["backend.php-cli"]),
            Technology("rails", "Ruby on Rails", ["backend"], ["backend.ruby-cli"]),
            Technology("rust", "Rust", ["backend"], ["backend.rust-cli"]),
